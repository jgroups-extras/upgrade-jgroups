...
public class UPGRADE extends UpgradeBase {
    protected static final Map<RelayHeader.Type,Byte> RELAY_TYPES_1=Map.of(
      ...
      HOST_UNREACHABLE, org.jgroups.protocols.relay.RelayHeader.MBR_UNREACHABLE,
    ...
    protected static final Map<Byte,RelayHeader.Type> RELAY_TYPES_2=Map.of(
      ...
      org.jgroups.protocols.relay.RelayHeader.MBR_UNREACHABLE, HOST_UNREACHABLE,
    ...
    protected static List<Header> jgHeadersToProtoHeaders(org.jgroups.Header[] jg_hdrs, Message jg_msg) {
    ...
    protected static org.jgroups.Header[] protoHeadersToJGHeaders(List<Header> proto_hdrs, org.jgroups.Message msg) {
        ...
        for(Header h: proto_hdrs) {
            if(h.hasRpcHdr())
                ...
                retval[index++]=protoRelayHeaderToJG(h.getRelayHdr()).setProtId((short)h.getProtocolId());
    ...
    protected static RelayHeader jgRelayHeaderToProto(org.jgroups.protocols.relay.RelayHeader jg_hdr) {
        RelayHeader.Type type=RELAY_TYPES_2.get(jg_hdr.getType());
        if(type == null)
            throw new IllegalArgumentException(String.format("type %s not recognized", type));
    ...
    protected static org.jgroups.Header protoRelayHeaderToJG(RelayHeader pbuf_hdr) {
